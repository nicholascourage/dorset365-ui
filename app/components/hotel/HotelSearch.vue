                                    ...
                                    <div class="tab-pane fade show active" id="home" role="tabpanel"
                                        ...
                                        <div class="room_booking_area">
                                            ...
                                            <div class="room_book_item">
                                                ...
                                                <div class="room_booking_right_side">
                                                    <div class="room_booking_heading">
                                                        <h3><NuxtLink to="/hotels/rooms/booking">Culpa cupidatat laborum eiusmod
                                                                amet</NuxtLink></h3>
                                            ...
                                            <div class="room_book_item">
                                                ...
                                                <div class="room_booking_right_side">
                                                    <div class="room_booking_heading">
                                                        <h3><NuxtLink to="/hotels/rooms/booking">Aliquip sit nisi est laboris
                                                                eiusmod</NuxtLink></h3>
                                                        <div class="room_fasa_area">
                                                            <ul>
                                                                <li><img src="../../assets/img/icon/ac.png"
                                            ...
                                            <div class="room_book_item">
                                                ...
                                                <div class="room_booking_right_side">
                                                    <div class="room_booking_heading">
                                                        <h3><NuxtLink to="/hotels/rooms/booking">Ea sint elit duis nostrud
                                                                consequat</NuxtLink></h3>
                                                        <div class="room_fasa_area">
                                                            <ul>
                                                                <li><img src="../../assets/img/icon/ac.png"
                                                                        alt="icon">Air
...
export default {
    ...
    data() {
        return {
            ...
            slides: [
                { img: "/img/hotel/small-1.png" },
                { img: "/img/hotel/small-2.png" },
                { img: "/img/hotel/small-3.png" },
                { img: "/img/hotel/small-4.png" },
                { img: "/img/hotel/small-5.png" },
                { img: "/img/hotel/small-6.png" }
            ]
